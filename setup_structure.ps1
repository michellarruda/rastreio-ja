# Rastreio Já — Setup completo (PowerShell nativo)
# Execute: .\setup_structure.ps1
...
Write-Host "  Rastreio Já — Criando estrutura..." -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""

# -------------------------------------------------------
Write-Host "[1/9] Assets..." -ForegroundColor Magenta
# -------------------------------------------------------
New-Dir "assets\images"
New-Dir "assets\animations"
New-Dir "assets\icons"
New-Dir "assets\fonts"

# -------------------------------------------------------
Write-Host ""
Write-Host "[2/9] Core / Constants..." -ForegroundColor Magenta
# -------------------------------------------------------

New-File "lib\core\constants\app_colors.dart" @(
...
New-File "lib\core\constants\app_strings.dart" @(
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[3/9] Core / Theme..." -ForegroundColor Magenta
# -------------------------------------------------------

New-File "lib\core\theme\app_theme.dart" @(
...
New-File "lib\core\theme\color_scheme_preset.dart" @(
...
New-File "lib\core\theme\theme_notifier.dart" @(
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[4/9] Core / Router..." -ForegroundColor Magenta
# -------------------------------------------------------
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[5/9] Core / Network..." -ForegroundColor Magenta
# -------------------------------------------------------
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[6/9] Core / Storage + Utils..." -ForegroundColor Magenta
# -------------------------------------------------------

New-File "lib\core\storage\hive_service.dart" @(
...
New-File "lib\core\storage\preferences_service.dart" @(
...
New-File "lib\core\utils\date_formatter.dart" @(
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[7/9] Feature: Tracking..." -ForegroundColor Magenta
# -------------------------------------------------------

New-File "lib\features\tracking\data\models\package_model.dart" @(
...
New-File "lib\features\tracking\data\models\tracking_event_model.dart" @(
...
New-File "lib\features\tracking\data\datasources\tracking_remote_datasource.dart" @(
...
New-File "lib\features\tracking\data\datasources\tracking_local_datasource.dart" @(
...
New-File "lib\features\tracking\data\repositories\tracking_repository_impl.dart" @(
...
New-File "lib\features\tracking\domain\entities\package_status.dart" @(
...
New-File "lib\features\tracking\domain\entities\tracking_event_entity.dart" @(
...
New-File "lib\features\tracking\domain\entities\package_entity.dart" @(
...
New-File "lib\features\tracking\domain\repositories\tracking_repository.dart" @(
...
New-File "lib\features\tracking\domain\usecases\add_package_usecase.dart" @(
...
New-File "lib\features\tracking\domain\usecases\get_packages_usecase.dart" @(
...
New-File "lib\features\tracking\domain\usecases\delete_package_usecase.dart" @(
...
New-File "lib\features\tracking\domain\usecases\refresh_tracking_usecase.dart" @(
...
New-File "lib\features\tracking\presentation\providers\packages_provider.dart" @(
...
New-File "lib\features\tracking\presentation\screens\home_screen.dart" @(
...
New-File "lib\features\tracking\presentation\screens\add_package_screen.dart" @(
...
New-File "lib\features\tracking\presentation\screens\package_detail_screen.dart" @(
...
New-File "lib\features\tracking\presentation\widgets\package_card.dart" @(
...
New-File "lib\features\tracking\presentation\widgets\tracking_timeline.dart" @(
...
New-File "lib\features\tracking\presentation\widgets\status_badge.dart" @(
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[8/9] Feature: Settings + Carriers..." -ForegroundColor Magenta
# -------------------------------------------------------
...
New-File "lib\features\settings\presentation\widgets\theme_picker.dart" @(
...
New-File "lib\features\settings\providers\settings_provider.dart" @(
...
New-File "lib\features\carriers\carrier_interface.dart" @(
...
New-File "lib\features\carriers\correios\correios_service.dart" @(
...
# -------------------------------------------------------
Write-Host ""
Write-Host "[9/9] Entry points + Testes..." -ForegroundColor Magenta
# -------------------------------------------------------
...
New-Dir "test\unit\tracking"
New-Dir "test\unit\theme"
New-Dir "test\widget"
New-Dir "test\integration"

New-File "test\unit\tracking\add_package_usecase_test.dart" @(
...
Write-Host ""
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Rastreio Já — Estrutura criada!         " -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Proximos passos:" -ForegroundColor Yellow
Write-Host "  1. dart run build_runner build --delete-conflicting-outputs" -ForegroundColor White
Write-Host "  2. flutter analyze" -ForegroundColor White
